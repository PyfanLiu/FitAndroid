...
public class TabLayoutBottomActivity extends BaseActivity {
    ...
    private void initTab(){
        ...
        mTabTl.setSelectedTabIndicatorHeight(0);//指示器的高度
        ViewCompat.setElevation(mTabTl, 100);
        mTabTl.setupWithViewPager(mContentVp);//将viewpage绑定到TabLayout上，效果点击自动切换
        ...
        mTabTl.getTabAt(0).getCustomView().setSelected(true);//默认选择
    }
