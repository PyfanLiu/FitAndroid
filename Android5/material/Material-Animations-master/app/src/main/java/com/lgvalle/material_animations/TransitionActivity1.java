...
public class TransitionActivity1 extends BaseDetailActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // com.lgvalle.material_animations.TransitionActivity1
        System.out.println("---getIntent().getComponent().getClassName():" + getIntent().getComponent().getClassName());
    }
    ...
    private void setupLayout() {
        ...
        findViewById(R.id.sample1_button6).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 ...
                 *
                 * 如果在这种情况下没有定义返回转换，Android将使用相反的enter转换，返回转换将是反向滑动(在buildEnterTransition中定义)
                 */
                finishAfterTransition();
            }
        });
