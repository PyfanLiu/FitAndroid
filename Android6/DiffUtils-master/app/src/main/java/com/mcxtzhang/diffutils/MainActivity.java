...
public class MainActivity extends AppCompatActivity {
    ...
    public void onRefresh(View view) {
        try {
            ...
            mNewDatas.add(new TestBean("赵子龙", "帅", R.drawable.pic6));//效果一：模拟新增数据

            mNewDatas.get(0).setDesc("Android+");//效果二：模拟修改数据
            mNewDatas.get(0).setPic(R.drawable.pic7);

            TestBean testBean = mNewDatas.get(1);//效果三：模拟数据位移
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    DiffUtil.DiffResult diffResult = DiffUtil.calculateDiff(
                            new DiffCallBack(mDatas, mNewDatas), true);
